...
================================================================================
【本文件说明】
从 HuggingFace `transformers` 复制的 ViLT 模型配置类（第三方代码）。

ViltConfig 定义了 ViLT 模型的所有结构超参数（hidden_size=768、
num_hidden_layers=12、image_size=384、patch_size=32 等），用于实例化
ViltModel。本项目在加载预训练权重时会自动读取 vilt-b32-mlm 目录下的
config.json 生成该配置。
================================================================================
"""

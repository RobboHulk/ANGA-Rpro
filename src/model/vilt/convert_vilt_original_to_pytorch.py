...
================================================================================
【本文件说明】
从 HuggingFace `transformers` 复制的权重转换脚本（第三方代码）。

作用：把原始 ViLT 官方仓库（dandelin/ViLT）发布的 checkpoint 权重，
通过重命名 key 的方式转换为 HuggingFace 格式，便于 ViltModel 加载。
本项目不需要运行此脚本（已直接使用 HuggingFace 格式的 vilt-b32-mlm 权重）。
================================================================================
"""

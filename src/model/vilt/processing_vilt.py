...
================================================================================
【本文件说明】
从 HuggingFace `transformers` 复制的 ViLT 图文联合处理器（第三方代码）。

ViltProcessor 把 BERT 分词器与 ViLT 图像处理器封装在一起，一次调用即可
同时完成文本与图像预处理。本项目主要直接使用其中的 ViltImageProcessor
与 BertTokenizer，较少直接使用本类。
================================================================================
"""
